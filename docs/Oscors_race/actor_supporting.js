...
var svg = d3.select("#actor_supporting")
  .append("svg")
  .attr("id", "chart")
  .attr("width", w)
  .attr("height", h)
...
svg.append("text")
      .attr("x", 150)
      .attr("y", 180)
      .html("The Best Actor in a supporting role")
      .style("font-size", 15)
      .style("font-family", "Helvetica")
    ...
    svg.append("text")
      .attr("x", 150)
      .attr("y", 197)
      .html("had the fewest winners who were white.")
      .style("font-size", 15)
      .style("font-family", "Helvetica")
    ...
    svg.append("text")
      .attr("x", 150)
      .attr("y", 214)
      .html("Yet, white actors still represent")
      .style("font-size", 15)
      .style("font-family", "Helvetica")
    ...
    svg.append("text")
      .attr("x", 150)
      .attr("y", 231)
      .html("88% of the winners for this award.")
      .style("font-size", 15)
      .style("font-family", "Helvetica")
    ...
    plots.selectAll(".rect")
      ...
      .on("mouseover", function(d){
            ...
            div.html("<span style = 'font-weight: bold'>" + d["Actor supporting role"] + "</span>" + "<br>" + "<span style = 'font-style: italic'>" + d.Movie_male + " " + "(" + d.Years + ")" + "</span>")
                  .style("font-family", "Helvetica")
