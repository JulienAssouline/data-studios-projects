...
var height = h - margin.top - margin.bottom;
           ...
           d3.csv("Actresss supporting role race - Sheet1.csv", function(error, data){
        ...
        grp_vals["grp" + o.White + o.Black + o["Hispanic or Latino"] + o.Mixed + o.Asian] = o;
    })

      var cells = [];
        d3.select("#grid_2").text().split("\n").forEach(function(line, i){
          var re = /\w+/g, m;
        ...
        valfields.forEach(function(v, i){
          ...
          var div = d3.select("#Female_support")
            .append("div")
            .attr("id", "charts")
