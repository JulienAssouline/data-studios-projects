(function () {
 ...
 var h = 450;
      ...
      var svg = d3.select("#stacked_female")
        .append("svg")
        .attr("id", "chart")
        .attr("width", w)
        .attr("height", h)
      ...
      var stack = d3.stack()
        ...
        colors_female = d3.scaleOrdinal()
          .range(["#e03f8d", "lightgrey"])
  ...
  d3.csv("star wars individual scenes Female.csv", function(error, data){
